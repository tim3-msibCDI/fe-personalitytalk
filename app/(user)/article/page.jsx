  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        setError(
          err.message || "Terjadi kesalahan saat mengambil data kategori."
        );
      } finally {
  ...
  const handleCategoryClick = (category) => {
    ...
    if (category) {
      ...
      if (selectedCategory) {
        ...
        ); // Simpan id kategori di localStorage
        fetchArticles();
      }
    } else {
      ...
      <div>
        ...
        <div className="relative flex items-center mt-4 px-6">
          {isLeftArrowVisible && (
            ...
            >
              <Image
                src="/image/icons/arrow-b-left.svg"
                alt="Scroll Left"
                width={16}
                height={16}
              />
          ...
          {isRightArrowVisible && (
            ...
            >
              <Image
                src="/image/icons/arrow-b-right.svg"
                alt="Scroll Right"
                width={16}
                height={16}
              />
      ...
      <div className="flex flex-wrap gap-y-5 gap-x-4 mt-2">
        {loadingArticles ? (
          ...
          <div className="flex flex-col w-full justify-center items-center p-16">
            ...
            <p className="text-m">
              Maaf, untuk saat ini belum ada artikel pada kategori tersebut
            </p>
          </div>
        )}
      </div>
