            ...
            {dashboardData && (
                <>
                    ...
                    >
                        ...
                        <div>
                            <h2 className="text-h2 font-semibold">{animatedCounts.totalClients.toLocaleString()}</h2>
                    ...
                    >
                        ...
                        <div>
                            <h2 className="text-h2 font-semibold">{animatedCounts.totalConsultations.toLocaleString()}</h2>
                    ...
                    >
                        ...
                        <div>
                            <h2 className="text-h2 font-semibold">{animatedCounts.totalScheduledConsultations.toLocaleString()}</h2>
                    ...
                    >
                        ...
                        <div>
                            <h2 className="text-h2 font-semibold">{animatedCounts.averageRating.toLocaleString()}</h2>
