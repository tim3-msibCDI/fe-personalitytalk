  ...
  return (
    <div className="py-6">
      ...
      <div className="flex gap-8 mt-6">
        ...
        <div className="w-2/5">
          <div className="py-4">
            <h3 className="text-h3 font-semibold text-textcolor mb-2">
              Pemesanan
            </h3>
            <p className="text-s text-textcolor mb-4">
              Lakukan pembayaran agar pemesanan sesi konsultasi kamu dapat
              dijadwalkan
            </p>
              ...
              <div className="p-4">
                <div className="flex gap-4">
                  ...
                  <div className="flex flex-col">
                    <p className="text-m font-semibold">
                      {selectedPsikolog.psikolog_name}
                    </p>
                ...
                <div className="text-m gap-2">
                  ...
                  <div className="grid grid-cols-2 gap-y-2 text-m text-textcolor">
                    ...
                    <p>
                      : {calculateDuration(selectedPsikolog.consultation_time)}{" "}
                      menit
                    </p>
        ...
        <div className="w-3/5">
          <div className="bg-primarylight2 rounded-lg p-4 mb-6">
            ...
            <p className="text-m mb-4">
              Metode Pembayaran yang tersedia: <b>Transfer BANK BSI</b>
            </p>
            ...
            <div>
              <label
                htmlFor="voucher"
                className="block mb-2 text-m font-semibold text-textcolor"
              >
                Voucher
              </label>
              <div className="flex flex-1 gap-2">
                ...
                <button
                  ...
                  className={`rounded-lg text-whitebg text-s px-4 ${
                    inputValue ? "bg-primary" : "bg-disable"
                  }`}
                  disabled={!inputValue}
                >
                  Reedem
            ...
            <div className="text-m mt-3 space-y-2">
              <div className="flex justify-between">
                ...
                <p>
                  <b>
                    {voucherData
                      ? formatPrice(voucherData.consul_fee)
            ...
            <div className="text-h3 font-semibold flex justify-between">
              ...
              <p>
                {voucherData
                  ? formatPrice(voucherData?.final_amount)
                  : formatPrice(selectedPsikolog.price)}
              </p>
            </div>
            {/* SNK */}
