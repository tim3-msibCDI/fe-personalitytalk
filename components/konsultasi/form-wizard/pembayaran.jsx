    ...
    if (status === "pending") {
      ...
      const timer = setInterval(() => {
        ...
        const remainingTime = Math.max(
          Math.floor((transactionEndTime - now) / 1000),
          0
        );
                ...
                <form className="space-y-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`bg-gray-50 border border-gray-300 ${
                        formValues.nama ? "text-black" : "text-text2"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`bg-gray-50 border border-gray-300 ${
                        formValues.rekening ? "text-black" : "text-text2"
                      } text-s rounded-lg block w-full p-2`}
                      value={formValues.rekening}
                      onChange={(e) =>
                        handleInputChange("rekening", e.target.value)
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`bg-gray-50 border border-gray-300 ${
                        formValues.bukti ? "text-black" : "text-text2"
                      } text-s rounded-lg block w-full p-2`}
                      onChange={(e) => {
                  ...
                  <button
                    ...
                    className={`w-full py-2 rounded-md font-semibold text-whitebg ${
          ...
          <>
            ...
            <div className="bg-primarylight2 rounded-b-lg text-s text-textcolor">
              <div className="px-6 py-32 text-center flex flex-col justify-center items-center">
                ...
                <p className="text-s">
                  Kami sedang memproses dan mengecek data Kamu dan akan
                  memberikan konfirmasi segera.
                </p>
              </div>
            </div>
          </>
